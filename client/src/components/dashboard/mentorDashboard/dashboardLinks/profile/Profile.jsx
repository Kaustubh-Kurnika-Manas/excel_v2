...
import OfficeBuildingIcon from "../../../../../assets/icons/OfficeBuildingIcon.jsx";
...
import ProfilePicDelModal from "./profilePicModal/ProfilePicDelModal.jsx";
import ProfilePicModal from "./profilePicModal/ProfilePicModal.jsx";
import ProfileModal from "./ProfileModal.jsx";
import StuModal from "./stuModal/StuModal.jsx";
    ...
    const handleShowModal = () => {
        ...
        if (role === Roles.MENTOR) {
            ...
            setStuProfileData({
                ...
                responsible_contact_person_at_residence: profileData?.responsible_contact_person_at_residence || "",
                        ...
                        <div className="bg-white px-5 py-10 rounded-md shadow-md flex-grow">
                            ...
                            <div className="grid grid-cols-3 w-full">
                                <div className="flex items-start justify-center flex-col mb-4">
                                    ...
                                    <h4 className="text-gray-800">{profileData?.firstname || ''}</h4>
                                </div>
                                <div className="flex items-start justify-center flex-col mb-4">
                                    <h4 className="text-gray-400">Middle Name</h4>
                                    <h4 className="text-gray-800">{profileData?.middlename || ''}</h4>
                                </div>
                                <div className="flex items-start justify-center flex-col mb-4">
                                    <h4 className="text-gray-400">Last Name</h4>
                                    <h4 className="text-gray-800">{profileData?.lastname || ''}</h4>
                                </div>
                    ...
                    <div className="col-span-4 p-2">
                        <div className="w-full shadow-m32 py-6 px-3 rounded-md mb-6 bg-white">
                            ...
                            <div className="flex items-center justify-start">
                                <img
                                    className="w-32 h-32 rounded-md mr-5 object-cover"
                                    src={
                                        profileData?.avatar?.url === ""
                                            ? `https://api.dicebear.com/9.x/personas/svg`
                                            : profileData?.avatar?.url
                            ...
                            <div className="grid grid-cols-6">
                                <div className="col-span-3">
                                    ...
                                    <div className="flex items-start justify-center flex-col">
                                        ...
                                        <h4 className="text-gray-800">{profileData?.enrollment_no || ''}</h4>
                                    </div>
                                </div>
                                <div className="col-start-4 col-span-3">
                                    <div className="flex items-start justify-center flex-col mb-4">
                                        <h4 className="text-gray-400">Programme</h4>
                                        <h4 className="text-gray-800">{profileData?.programme || ''}</h4>
                                    </div>
                                    <div className="flex items-start justify-center flex-col mb-4">
                                    ...
                                    <div className="flex items-start justify-center flex-col">
                                        ...
                                        <h4 className="text-gray-800">{profileData?.enrollment_year || ''}</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="w-full bg-white shadow-m32 py-5 px-3 rounded-md">
                            ...
                            <div className="">
                                <div className="flex flex-col items-start mb-4">
                                    ...
                                    <h4 className="text-gray-800">{profileData?.email || ''}</h4>
                                </div>
                                <div className="flex flex-col items-start mb-4">
                                    <h4 className="text-gray-400">Phone Number</h4>
                                    <h4 className="text-gray-800">{profileData?.phone_no || ''}</h4>
                                </div>
                                <div className="flex flex-col items-start">
                                    <h4 className="text-gray-400">Address</h4>
                                    <h4 className="text-gray-800">{profileData?.address || ''}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
